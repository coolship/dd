...
class Home extends Component {
  ...
  <div>
    <section id="welcome"><h1>WELCOME</h1><div className="biline">To <b>DNA-Microscopy.org</b>,
	    the web platform for the sequencing-based imaging tool developed  in [REFERENCE].<p><LoginWithGoogle/></p></div></section>
    <section id="gallery"><h1>GALLERY</h1><div className="biline"><NavLink to="/gallery">Explore sample datasets</NavLink></div></section>
